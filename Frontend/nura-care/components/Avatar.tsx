...
export const Avatar: React.FC<AvatarProps> = ({ size = 'md', emotion = 'neutral', type = 'jellyfish' }) => {
  const sizeClasses = {
    sm: 'w-10 h-14',
    md: 'w-20 h-28',
    lg: 'w-28 h-40',
  ...
  const renderFace = () => (
    <div className={`flex items-center gap-4 z-30`}>
      <div className={`${eyeSize[size]} bg-slate-800 rounded-full animate-pulse shadow-sm`} />
      <div className="flex items-center justify-center min-w-[10px]">
        {emotion === 'happy' ? (
          ...
          <div className="w-4 h-4 bg-slate-800 rounded-full animate-ping opacity-60" />
        ) : (
      ...
      case 'panda':
        return (
          <div className="w-full h-[70%] bg-gradient-to-b from-white to-slate-100 rounded-full shadow-[inset_0_-4px_12px_rgba(0,0,0,0.1),0_8px_24px_rgba(0,0,0,0.2)] border border-white flex flex-col items-center justify-center relative overflow-visible">
             ...
             {/* Darker eye spots but not as dark as eyes */}
      ...
      case 'axolotl':
        return (
          <div className="w-full h-[70%] relative flex items-center justify-center">
             {/* Frills rendered BEHIND the body */}
        ...
        return (
          <>
            <div className="relative w-full h-[58%] bg-gradient-to-b from-white/80 via-[#a4c0fc] to-[#7ba4f7] rounded-t-[65%] rounded-b-[40%] shadow-[inset_0_-4px_12px_rgba(255,255,255,0.4),inset_0_-8px_16px_rgba(0,0,0,0.1),0_8px_24px_rgba(0,0,0,0.2)] flex flex-col items-center justify-center border border-white/40 z-20 overflow-hidden">
              <div className="absolute top-2 left-1/4 w-1/4 h-1/6 bg-white/50 rounded-full blur-sm rotate-[-15deg]" />
            ...
            <div className="w-[75%] h-[28%] -mt-2 relative z-10">
              <svg viewBox="0 0 100 40" className="w-full h-full drop-shadow-[0_2px_4px_rgba(164,192,252,0.5)]" preserveAspectRatio="none">
                <path d="M 25 0 Q 20 10, 25 20 T 25 35" fill="none" stroke="rgba(164, 192, 252, 0.8)" strokeWidth="9" strokeLinecap="round" className="tentacle-path" style={{ animationDelay: '0s' }} />
                <path d="M 50 0 Q 55 10, 50 20 T 50 40" fill="none" stroke="rgba(164, 192, 252, 0.6)" strokeWidth="9" strokeLinecap="round" className="tentacle-path" style={{ animationDelay: '0.4s' }} />
                <path d="M 75 0 Q 70 10, 75 20 T 75 35" fill="none" stroke="rgba(164, 192, 252, 0.8)" strokeWidth="9" strokeLinecap="round" className="tentacle-path" style={{ animationDelay: '0.8s' }} />
              </svg>
            </div>
          </>
        );
  ...
  return (
    <div className={`${sizeClasses[size]} relative flex flex-col items-center group transition-transform duration-500 hover:scale-105`}>
      <div className="w-full h-full relative floating-anim flex flex-col items-center">
