...
export const RoleSelection: React.FC<RoleSelectionProps> = ({ onSelectRole, onBack }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 animate-in fade-in zoom-in duration-700 bg-transparent">
      ...
      <h1 className="text-5xl font-black mb-2 text-center tracking-tighter text-[var(--nura-text)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-3xl">
        ...
        <button 
          ...
          className="bg-[var(--nura-card)] p-10 rounded-[2.5rem] flex flex-col items-center gap-6 border-white/10 shadow-2xl hover:bg-nura-accent/20 transition-all group active:scale-95 bg-[var(--nura-bg)]/40"
        >
          <div className="w-20 h-20 rounded-3xl bg-indigo-500/20 flex items-center justify-center group-hover:bg-indigo-500/30 transition-colors">
            <HeartPulse className="w-10 h-10 text-[var(--nura-dim)]" />
          </div>
          <div className="text-center">
            <h2 className="text-3xl font-black text-[var(--nura-text)] mb-2">Caregiver</h2>
        ...
        >
          ...
          <div className="text-center">
            <h2 className="text-3xl font-black text-[var(--nura-text)] mb-2">Patient</h2>
